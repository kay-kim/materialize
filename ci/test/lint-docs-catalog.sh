...
catalog_files=(
  doc/user/content/self-managed/v2025.01/sql/system-catalog/mz_internal.md
  doc/user/content/self-managed/v2025.01/sql/system-catalog/mz_introspection.md
  doc/user/content/self-managed/v2025.01/sql/system-catalog/mz_catalog.md
)
