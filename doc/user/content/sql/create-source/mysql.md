...
If you're running MySQL using a managed service, additinal configuration changes
might be required. For step-by-step instructions on enabling GTID-based binlog
replication for your MySQL service, see the [integration guides](/ingest-data/mysql/)
