...
description: "Legacy syntax for connecting Materialize to a SQL Server database for Change Data Capture (CDC)."
pagerank: 40
menu:
  main:
...
other_ref="[new reference page](/sql/create-source/sql-server/)" include_blurb=true
>}}
