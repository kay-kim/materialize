---
title: "CREATE SOURCE (Legacy)"
description: "`CREATE SOURCE` connects Materialize to an external data source. This is a legacy syntax."
disable_list: true
menu:
  main:
    parent: commands
    identifier: 'create-source-v1'
---

{{< source-versioning-disambiguation is_new=false 
other_ref="[new reference page](/sql/create-source/)" include_blurb=false >}}
