...
menu:
  main:
    ...
    weight: 10
aliases:
  - /self-managed/v2025.01/ops/network-security/static-ips/
  - /self-managed/v2025.01/connect-sources/static-ips/
---
...
querying the [`mz_egress_ips`](/self-managed/v2025.01/sql/system-catalog/mz_catalog/#mz_egress_ips)
...
[SQL API](/self-managed/v2025.01/integrations/http-api/) querying the [`mz_egress_ips`](/self-managed/v2025.01/sql/system-catalog/mz_catalog/#mz_egress_ips)
