...
menu:
  main:
    ...
    name: "RudderStack"
aliases:
  - /self-managed/v2025.01/ingest-data/rudderstack/
---
...
To validate requests between Rudderstack and Materialize, you must create a [secret](/self-managed/v2025.01/sql/create-secret/):
