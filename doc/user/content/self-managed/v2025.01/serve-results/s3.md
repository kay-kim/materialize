...
processing in analytical data warehouses like [Snowflake](/self-managed/v2025.01/serve-results/snowflake/),
...
write files to it. We **strongly** recommend using [role assumption-based authentication](/self-managed/v2025.01/sql/create-connection/#aws-permissions)
...
1. In **Trusted entity type**, select **Custom trust policy**, and copy and
   ...
   across all Materialize regions (see [AWS connection permissions](/self-managed/v2025.01/sql/create-connection/#aws-permissions)).
...
1. In the [SQL Shell](https://console.materialize.com/), or your preferred SQL
   client connected to Materialize, create an [AWS connection](/self-managed/v2025.01/sql/create-connection/#aws),
...
To export data to your target S3 bucket, use the [`COPY TO`](/self-managed/v2025.01/sql/copy-to/#copy-to-s3)
...
type support and conversion, check the [reference documentation](/self-managed/v2025.01/sql/copy-to/#copy-to-s3-parquet).
