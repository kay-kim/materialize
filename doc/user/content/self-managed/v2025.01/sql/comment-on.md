...
To read the comment on an object you need to query the [mz_internal.mz_comments](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_comments)
catalog table.
...
information on ownership and privileges, see [Role-based access control](/self-managed/v2025.01/manage/access-control/rbac).
