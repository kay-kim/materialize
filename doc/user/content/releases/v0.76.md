...
* Support previewing the Avro schema that will be generated for an
  Avro-formatted [Kafka sink](/self-managed/v2025.01/sql/create-sink/kafka/) ahead of sink creation
  using the [`EXPLAIN { KEY | VALUE } SCHEMA`](/self-managed/v2025.01/sql/explain-schema/) syntax.

#### Bug fixes and other improvements

* Improve [connection validation](/self-managed/v2025.01/sql/create-connection/#connection-validation)
