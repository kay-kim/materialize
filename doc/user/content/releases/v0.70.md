...
* Automatically check if there are tables not currently configured to use `REPLICA IDENTITY FULL` in a publication used with a [PostgreSQL source](/self-managed/v2025.01/sql/create-source/postgres/).
