...
* Add [`mz_internal.mz_subscriptions`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_subscriptions)
...
* Add support for new SQL functions:
  ...
  | ----------------------------------------------- | ----------------------------------------------------------------------- |
  | [`uuid_generate_v5`](/self-managed/v2025.01/sql/functions/#uuid-functions) | Generates a UUID in the given namespace using the specified input name. |
...
* Add the [`ALTER ROLE`](/self-managed/v2025.01/sql/alter-role) command, as well as role attributes to
  the [`CREATE ROLE`](/self-managed/v2025.01/sql/create-role/) command. This is part of the work to
...
* Stabilizate resource utilization in the [`mz_introspection`](/self-managed/v2025.01/sql/show-clusters/#mz_catalog_server-system-cluster)
  system cluster.
