...
* Add [`mz_internal.mz_cluster_replica_history`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_cluster_replica_history)
...
* Add `envelope_state_bytes` and `envelope_state_count` to the
  [`mz_internal.mz_source_statistics`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_source_statistics)
...
* Improve and extend the base implementation of **Role-based
  ...
  * Add support for the [`DROP OWNED`](/self-managed/v2025.01/sql/drop-owned/) command, which drops
