...
* Add support for replicating tables that contain unsupported types in the
  [PostgreSQL source](/self-managed/v2025.01/sql/create-source/postgres/), using the new `TEXT
  COLUMNS` option:
...
* Fix a bug in the [`#>>` `jsonb` operator](/self-managed/v2025.01/sql/types/jsonb/#operators) that
...
* **Private preview.** Add support for
  [AWS PrivateLink connections](/self-managed/v2025.01/sql/create-connection/#aws-privatelink),
