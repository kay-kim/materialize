...
* Add [`mz_internal.mz_dataflow_arrangement_sizes`](/self-managed/v2025.01/sql/system-catalog/mz_introspection/#mz_dataflow_arrangement_sizes)
...
* Improve the usability of subscriptions when using the [`WITH (PROGRESS)`](/self-managed/v2025.01/sql/subscribe/#progress)
