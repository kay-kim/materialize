...
* Add the `bool_and` and `bool_or` [aggregate functions](/self-managed/v2025.01/sql/functions/#aggregate-functions),
...
* Fix a bug where active [subscriptions](/self-managed/v2025.01/sql/subscribe/) were not terminated when
