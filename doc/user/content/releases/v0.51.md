...
* Add support for replicating tables from specific schemas in the
  [PostgreSQL source](/self-managed/v2025.01/sql/create-source/postgres/), using the new `FOR SCHEMAS(...)`
  option:
...
* Add the `translate` [string function](/self-managed/v2025.01/sql/functions/#string-functions), which
