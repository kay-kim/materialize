...
* Support specifying multiple roles in the [`GRANT ROLE`](/self-managed/v2025.01/sql/grant-role) and
  [`REVOKE ROLE`](/self-managed/v2025.01/sql/revoke-role) commands.
...
* Add [`mz_internal.mz_sessions`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_sessions)
