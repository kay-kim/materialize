...
by [`mz_recent_activity_log`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_recent_activity_log),
which contains a log of the SQL statements that have been issued to
Materialize in the past 3 days.

* Add [`mz_internal.mz_compute_operator_hydration_statuses`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_compute_operator_hydration_statuses)
