...
* Improve and extend the base implementation of **Role-based
  ...
  * Include `GRANT`, `REVOKE`, `ALTER DEFAULT PRIVILEGES`, and `ALTER OWNER`
    events in the [`mz_audit_events`](/self-managed/v2025.01/sql/system-catalog/mz_catalog/#mz_audit_events)
    system catalog table.

  * Require connection and secret `USAGE` privileges to execute [`CREATE SINK`](/self-managed/v2025.01/sql/create-sink/)
    commands.
