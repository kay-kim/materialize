...
* Add the [`INCLUDE HEADER` option](/self-managed/v2025.01/sql/create-source/kafka/#headers) to Kafka
...
* Add [`mz_timezone_names`](/self-managed/v2025.01/sql/system-catalog/mz_catalog/#mz_timezone_names)
and [`mz_timezone_abbreviations`](/self-managed/v2025.01/sql/system-catalog/mz_catalog/#mz_timezone_abbreviations)
