...
* Add [`mz_aws_privatelink_connection_status_history`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_aws_privatelink_connection_status_history)
  to the system catalog. This table contains a row describing the historical
  status for each [AWS PrivateLink connection](/self-managed/v2025.01/sql/create-connection/#aws-privatelink)
  in the system.

#### SQL

* Add [`mz_compute_hydration_status`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_compute_hydration_statuses)
  ...
  objects are "caught up" in the context of [blue/green deployments](/self-managed/v2025.01/manage/blue-green).
