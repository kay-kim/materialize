...
* Add [`mz_internal.mz_recent_activity_log`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_recent_activity_log)
...
* Fix a bug where [`DISCARD ALL`](/self-managed/v2025.01/sql/discard/) did not consider system or role
  defaults {{% gh 24601 %}}.
