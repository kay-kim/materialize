...
* Change the type of the following system catalog replica ID columns from integer to string:
    ...
    * [`mz_catalog.mz_cluster_replicas.id`](/self-managed/v2025.01/sql/system-catalog/mz_catalog/#mz_cluster_replicas)
    * [`mz_internal.mz_cluster_replica_statuses.replica_id`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_cluster_replica_statuses)
    * `mz_internal.mz_cluster_replica_heartbeats.replica_id`
    * [`mz_internal.mz_cluster_replica_metrics.replica_id`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_cluster_replica_metrics)
...
* Add the [`ALTER OWNER`](/self-managed/v2025.01/sql/alter-owner/) command, which updates the owner
