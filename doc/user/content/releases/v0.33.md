...
* Add support for connecting to Kafka brokers using an [SSH tunnel connection](/self-managed/v2025.01/sql/create-connection/#ssh-tunnel)
...
* Add [`mz_internal.mz_source_status`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_source_statuses) and
  [`mz_internal.mz_source_status_history`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_source_status_history)
