...
* Allow _superusers_ to modify the default value for certain [configuration parameters](/self-managed/v2025.01/sql/set/#other-configuration-parameters)
  globally (i.e. for all users) using the[`ALTER SYSTEM...SET`](/self-managed/v2025.01/sql/alter-system-set/)
  command.
...
* Add [`mz_hydration_statuses`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_hydration_statuses)
  to the system catalog. This view describes the per-replica hydration status of
  each object powered by a dataflow.

#### Bug fixes and other improvements

* Rename `mz_compute_hydration_status` to [`mz_compute_hydration_statuses`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_compute_hydration_statuses),
