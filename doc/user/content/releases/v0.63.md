...
* Improve and extend the base implementation of **Role-based
  ...
  * Add system catalog views that present privileges and role memberships using
    ...
    * [`mz_internal.mz_show_[my_]cluster_privileges`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_show_cluster_privileges)
    * [`mz_internal.mz_show_[my_]database_privileges`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_show_database_privileges)
    * [`mz_internal.mz_show_[my_]default_privileges`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_show_default_privileges)
    * [`mz_internal.mz_show_[my_]object_privileges`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_show_object_privileges)
    * [`mz_internal.mz_show_[my_]schema_privileges`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_show_schema_privileges)
    * [`mz_internal.mz_show_[my_]system_privileges`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_show_system_privileges)

    **Roles**

    * [`mz_internal.mz_show_[my_]role_members`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_show_role_members)
