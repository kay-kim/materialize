...
* **Private preview.** Support filter pushdown, which can substantially improve
    ...
    optimization mechanism, check the [updated documentation](/self-managed/v2025.01/transform-data/patterns/temporal-filters/#temporal-filter-pushdown).
...
* Support [`FORMAT JSON`](/self-managed/v2025.01/sql/create-source/#json) for [Kafka sources](/self-managed/v2025.01/sql/create-source/kafka/).
...
* Improve and extend the base implementation of **Role-based
  ...
  * Restrict granting and revoking [system privileges](/self-managed/v2025.01/manage/access-control/manage-privileges/)
