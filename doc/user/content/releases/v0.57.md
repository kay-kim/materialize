...
* Improve and extend the base implementation of **Role-based
  ...
  * Allow specifying multiple database objects in the [`GRANT PRIVILEGE`](/self-managed/v2025.01/sql/grant-privilege)
    and [`REVOKE PRIVILEGE`](/self-managed/v2025.01/sql/revoke-privilege) commands.
...
* Add support for new SQL functions:
  ...
  | ----------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
  | [`array_position`](/self-managed/v2025.01/sql/functions/#array-functions)  | Returns the subscript of the first occurrence of the second argument in the array. `NULL` if not found.     |
  | [`parse_ident`](/self-managed/v2025.01/sql/functions/#string-functions)    | Splits a qualified identifier into an array of identifiers, removing any quoting of individual identifiers. |
