...
* Add [`mz_internal.mz_sink_statistics`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_sink_statistics)
...
* Add [`mz_internal.mz_postgres_sources`](/self-managed/v2025.01/sql/system-catalog/mz_internal/#mz_postgres_sources)
...
* Allow placing sources and sinks in existing clusters using the `IN CLUSTER`
  clause in [`CREATE SOURCE`](/self-managed/v2025.01/sql/create-source) and [`CREATE SINK`](/self-managed/v2025.01/sql/create-sink)
...
* Support using [`SUBSCRIBE`](/self-managed/v2025.01/sql/subscribe) with queries over introspection
  sources for [troubleshooting](/self-managed/v2025.01/ops/troubleshooting/).
