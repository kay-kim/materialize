...
* **Private preview.** Allow propagating comments in materialized views to the
    Avro schema of [Kafka sinks](/self-managed/v2025.01/sql/create-sink/kafka/), as well as manually
    specifying comments using the new `[KEY|VALUE] DOC ON
    [TYPE|COLUMN] <identifier>` [connection option](/self-managed/v2025.01/sql/create-sink/kafka/#csr-connection-options).
...
* Allow the value of the `SASL MECHANISM` option for [Kafka connections](/self-managed/v2025.01/sql/create-connection/#kafka)
