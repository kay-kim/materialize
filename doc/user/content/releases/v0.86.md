...
* Add support for new SQL functions:
  ...
  | ----------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
  | [`map_build`](/self-managed/v2025.01/sql/functions/#map_build) | Builds a map from a list of records whose fields are two elements, the first of which is `text`.     |
  | [`map_agg`](/self-managed/v2025.01/sql/functions/#map_agg)    | Aggregate keys and values (including nulls) as a map. |
