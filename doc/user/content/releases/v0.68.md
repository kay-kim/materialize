...
* Enable Role-based access control (RBAC) for all new environments. Check the
  [updated documentation](/self-managed/v2025.01/manage/access-control/) for guidance on setting up
  RBAC in your Materialize organization.

* Extend the [`EXPLAIN PLAN`](/self-managed/v2025.01/sql/explain-plan/) syntax to allow explaining
