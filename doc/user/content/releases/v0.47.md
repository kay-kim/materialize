...
* Add the [`GRANT ROLE`](/self-managed/v2025.01/sql/grant-role) and [`REVOKE ROLE`](/self-managed/v2025.01/sql/revoke-role)
...
* Add [`mz_internal.mz_dataflow_operator_parents`](/self-managed/v2025.01/sql/system-catalog/mz_introspection/#mz_dataflow_operator_parents)
...
* Add `dataflow_id` to the [`mz_compute_exports`](/self-managed/v2025.01/sql/system-catalog/mz_introspection/#mz_compute_exports)
