...
* **Private preview.** Add a new [MySQL source](/self-managed/v2025.01/sql/create-source/mysql/),
  ...
  **Syntax**
  ...
  ```
    ...
    [Amazon RDS for MySQL](/self-managed/v2025.01/ingest-data/mysql/amazon-rds/),
    [Amazon Aurora MySQL](/self-managed/v2025.01/ingest-data/mysql/amazon-aurora/),
    [Azure DB for MySQL](/self-managed/v2025.01/ingest-data/mysql/azure-db/),
    and [Google Cloud SQL for MySQL](/self-managed/v2025.01/ingest-data/mysql/google-cloud-sql/).
