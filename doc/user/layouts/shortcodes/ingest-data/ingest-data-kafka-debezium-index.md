In Materialize, [indexes](/self-managed/v2025.01/concepts/indexes) on views compute and, as new data
arrives, incrementally update view results in memory within a
[cluster](/self-managed/v2025.01/concepts/clusters/) instead of recomputing the results from scratch.
...
[Indexes](/self-managed/v2025.01/concepts/indexes/) and [Views](/self-managed/v2025.01/concepts/views/).
